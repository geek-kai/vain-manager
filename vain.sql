...
CREATE TABLE `t_role_menu` (
  ...
  `modifyTime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 COMMENT='保存角色和菜单的关联关系数据';
...
INSERT INTO `t_user` VALUES ('5', '2', 'admin1', 'a0bca5d6fede811f6238a0eb475e2931', 'f74518bf-9b68-4f42-a680-eb3abdeaa1d6', null, null, '0', null, '0', null, null, null, null, null, null, null, '0', '2017-10-26 15:18:56', '2017-10-26 15:26:19');
...
CREATE TABLE `t_user_menu` (
  ...
  `modifyTime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='保存用户与菜单的管理关系数据';

-- ----------------------------
-- Records of t_user_menu
-- ----------------------------
INSERT INTO `t_user_menu` VALUES ('1', '6', '120000', '2017-10-26 15:24:49', null);
INSERT INTO `t_user_menu` VALUES ('2', '6', '120100', '2017-10-26 15:24:49', null);
INSERT INTO `t_user_menu` VALUES ('3', '6', '120101', '2017-10-26 15:24:49', null);
INSERT INTO `t_user_menu` VALUES ('4', '5', '110000', '2017-10-26 18:49:00', null);
INSERT INTO `t_user_menu` VALUES ('5', '5', '110100', '2017-10-26 18:49:00', null);
INSERT INTO `t_user_menu` VALUES ('6', '5', '110101', '2017-10-26 18:49:00', null);
INSERT INTO `t_user_menu` VALUES ('7', '5', '110200', '2017-10-26 18:49:00', null);
INSERT INTO `t_user_menu` VALUES ('8', '5', '110201', '2017-10-26 18:49:00', null);
