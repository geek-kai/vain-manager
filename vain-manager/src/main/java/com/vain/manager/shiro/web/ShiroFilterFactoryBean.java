package com.vain.manager.shiro.web;

import com.vain.manager.shiro.filter.PermissionFilterManager;
...
public class ShiroFilterFactoryBean implements FactoryBean, BeanPostProcessor {
	 ...
	 * creating {@link #setFilterChainDefinitionMap(Map) filter chain
	 * definitions}.
	 * <p/>
	...
	/**
	 * A convenience method that sets the null null null null null
	 * {@link #setFilterChainDefinitionMap(Map)
	...
	/**
	 * Returns
	 * <code>{@link AbstractShiroFilter}.class</code>
	 *
	...
	protected FilterChainManager createFilterChainManager() {
		...
		FilterChainManager manager = null;
		if (null != this.getFilterChainManager()) {
			manager = this.getFilterChainManager();
		} else {
			manager = new DefaultFilterChainManager();
		}
		...
		if (manager instanceof PermissionFilterManager) {
			((PermissionFilterManager) manager).init();
		}
	 ...
	 * This implementation:
	 * <ol>
	 * <li>Ensures the required null null null null null
	 * {@link #setSecurityManager(SecurityManager)
	 ...
	 * {@link #setFilters(Map) filters} and null null null null null
	 * {@link #setFilterChainDefinitionMap(Map) filter chain
	 * definitions}</li>
	 * <li>Wraps the FilterChainManager with a suitable null null null null null
	 ...
	 * {@link #setFilters(Map) filters map} that will be referenced
	 ...
	 * {@link AbstractShiroFilter}'s null null null null null
	 * {@link AbstractShiroFilter#setSecurityManager(WebSecurityManager)
	 * securityManager} and null null null null null
	 * {@link AbstractShiroFilter#setFilterChainResolver(FilterChainResolver)
